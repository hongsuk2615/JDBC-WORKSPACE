...
//view : 사용자가 보게될 시각적인 요소를 담당(화면 입출력)
...
public class MemberView {
	...
	/**
	 * 회원추가용 화면 추가하고자 하는 회원의 정보를 입력받아서 추가 요청 할 수 있는 화면.
	 */
	...
	/**
	 * 사용자에게 이름 키워드를 입력받은 후 조회 요청하는 메서드
	 */
	public void selectByUserName() {
		System.out.println("---- 회원 이름 키워드 검색 ----");

		System.out.print("회원 이름 키워드 입력 : ");
		String keyword = sc.nextLine(); // --> USERNAME LIKE '%keyword%'
